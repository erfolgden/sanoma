...
class TestHomePage(BaseTest):
    ...
    BAR_LINK_ORDER = [u'HOME', u'GEZOND LEVEN', u'LEKKER ETEN', u'MODE & BEAUTY', u'VIDEO', u'INTERVIEWS', u'REISAANBIEDINGEN',  u'MEER']
    ...
    INTERVIEWS_SUB_TAB = [u'HARTEKREET', u'NOG NOOIT VERTELD', u'GESPREK VD DAG', u'BN-ERS']
